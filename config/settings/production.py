...
ALLOWED_HOSTS = env.list(
    ...
    default=[FLY_HOSTNAME, "www.{{project_name}}.com", "health.check"],
)
...
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "{{project_name}}.contrib.storages.storages.MediaStorage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="{{project_name}} <noreply@{{project_name}}.com>",
)
